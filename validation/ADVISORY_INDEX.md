...
| ADVISORY_SREVIEW_prompt_2026-08-31.md | advisory-prompt | PENDING-CONTRACT | F2-B0 close -> S-REVIEW (revisione agnostica delle fondamenta, milestone F2-entry; user decision 2026-09-05) -> F2.REPR (consumes the assessment) | prompt di sessione S-REVIEW: perche ora (misurato), apertura R2+R8 (consumatore = referee JPP del numero decisivo + PM; tetto proposto Stage A ~12 / Stage B ~18 agenti, cap 6 voci; confine rabbit-hole), touchpoint T1-T4 (tetto, perimetro livelli 2/3, esito PILOT, red team del nord), ordini 1-9 (refuter sul prompt; enunciato agnostico + lint di agnosticita; Stage A derivatori de-novo per sottoproblema; diff vs incumbent + triage; Stage B panel a convergenza con falsificatore concordato e dual-seed; red team del nord; verifica indipendente; landing inline con GO/NO-GO; refuter di chiusura), vincoli (Workflow solo nelle fasi derive/diff/converge/verify), criteri E1-E6 |
