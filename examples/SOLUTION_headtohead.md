...
**(c) Mass flow from thrust:** SK pressure-history bracket F/Ṁ = 1979.1 m/s (Term I 1679.1 + Term II 300.0 = 15.2%) ⇒ ṁ = 600/1979 ≈ **0.303 kg/s** (axial-flow CV: 1904.7 m/s ⇒ 0.315 kg/s — the two CVs bracket the requirement). CJ state is ṁ-independent: the chain scales linearly.
