...
\begin{tabular}{lcc}
\toprule
march resolution & gain over the streamline & diff ratio \\
\midrule
$(61,51)$      & $+0.303\,\%$ & \\
$(121,101)$    & $+0.196\,\%$ & $0.829$ \\
$(241,201)$    & $+0.108\,\%$ & $0.622$ \\
...
\noindent The ratios settle onto the march's own first order, the
model predicted the sixth rung before seeing it ($+0.0053\%$
predicted, $+0.0062\%$ measured --- a miss eighteen times smaller
than the step it predicted), and the extrapolated limit is
\begin{equation}
