...
| 4 | Per-phase gradient (closed-form adjoint / reverse-AD) | closed-form adjoint = Rao/Kraiko (P2 three published banks); AD with implicit rules: SOTA | any S1 per-phase physics incl. nonuniform vortical (Kraiko generality) | exactness certified (O3 dot-product, Hoffman E-residual) | PASS |
