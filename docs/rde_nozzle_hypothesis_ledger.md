...
| H-T4 ideal-adaptation closure | PRICED | Declared model closure [C-HT4] with published bound precedent (Kraiko-Egoryan); sonic cap of record (M0 Prop. 7 sharpening); PB-2 truncation/base-pressure band = the falsifier; N2 stays THE declared open problem. |
