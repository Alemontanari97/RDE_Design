...
## 5/6 FAIL [X-OWSQ] (falsificatore P3 scattato: ritorno in VALORE
## +18 N, non in POSIZIONE, 1.17x band_W; floor di posizione
## sotto-dichiarato — addendum A del log S28); (4) catena di rigenerazione degli
